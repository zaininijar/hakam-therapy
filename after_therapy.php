            ...
            <div
                ...
                <form class="mt-8" action="" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="flex">
                            ...
                            <input required type="date" name="date" id="date"
                                ...
                                class="__input-text w-1/2 border-l-0 rounded-l-none" value="<?= date('Y-m-d') ?>" />
                        </div>
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        ...
                        <input required type="text" name="therapyst" id="therapyst" placeholder="Isikan nama Therapis"
                            class="__input-text" />
                    </div>
                    <div class="mb-5">
                        <label for="price" class="mb-3 block text-base font-light">
