...
if (isset($_GET['id'])) {
    ...
    $after_query = "SELECT * FROM therapy_register WHERE id=$id";
...
if (isset($_POST['update'])) {
    ...
    $_SESSION['message_register_therapy'] = "Berhasil Update Data Pendaftaran Therapy di HakamTherapy";
}
            ...
            <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                <div class="overflow-hidden">
                    <div class="mx-auto w-full ">
                        <h2 class="text-2xl font-bold">Isi Formulir Pendaftaran Therapy</h2>
