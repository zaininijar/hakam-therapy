...
if (isset($_POST['done'])) {
    ...
    $_SESSION['message_register_therapy'] = "Berhasil Menyelesaikan Therapy di HakamTherapy";
}
                        ...
                        <form class="mt-8" action="" method="POST">
                            ...
                            <div class="mb-5">
                                ...
                                <textarea required rows="4" name="address" id="address"
                                    placeholder="Isikan alamat lengkap anda" class="__textarea"></textarea>
                            </div>
                            <div class="mb-5">
                                <label for="village" class="mb-3 block text-base font-light">
                                    Desa
                                </label>
                                <input required type="text" name="village" id="village"
                                    placeholder="Isikan nama desa anda" class="__input-text" />
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <input required type="text" name="therapyst" id="therapyst"
                                    placeholder="Isikan nama Therapis" class="__input-text" />
                            </div>
                            <div class="mb-5">
                                <label for="price" class="mb-3 block text-base font-light">
                                    Pembayaran
